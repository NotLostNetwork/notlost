...
export const AboveKeyboardModal = ({
  ...
  return (
    <div
      className={`fixed top-0 left-0 flex items-center justify-center transition-all ease-in-out duration-300 ${isOpen ? "opacity-100" : "opacity-20 pointer-events-none"}"`}
