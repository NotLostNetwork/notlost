...
export const AboveKeyboardModal = ({
  ...
  return (
    ...
    >
      <div>
        <div
          className={`bg-secondary  shadow-lg pt-2 pb-2 transform transition-all ease-in-out  absolute left-0  w-full ${focused ? "duration-150 delay-0 bottom-0" : "duration-300 bottom-1/2"}`}
          onClick={(e) => e.stopPropagation()}
        >
          {children}
        </div>
